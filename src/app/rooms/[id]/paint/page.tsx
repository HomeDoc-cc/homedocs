...
export default function RoomPaintPage({ params }: RoomPaintPageProps) {
  ...
  const fetchPaints = async () => {
    const response = await fetch(`/api/rooms/${params.id}/paint`);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">Room Paint</h1>
        <button
